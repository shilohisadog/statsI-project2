...
# Mean number of points scored for our team
mean_pts_your_team = your_team_df['pts'].mean()
print("Mean Number of Points Scored by our team in the years 2013 to 2015 =", round(mean_pts_your_team,2))
...
# Hypothesis Test
test_statistic, p_value = proportions_ztest(counts, nobs, .90, prop_var= .90)
